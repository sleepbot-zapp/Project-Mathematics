...
class Derivative:
    ...
    def __init__(self, WIDTH, HEIGHT, surface):
        ...
        self.order_box = pygame_gui.elements.UITextEntryLine(
            ...
            relative_rect=pygame.Rect((((self.WIDTH -(self.WIDTH // 3.6))//2), 160), (self.WIDTH // 7.2 - 5, 50)), 
        ...
        self.calculate_button = pygame_gui.elements.UIButton(
            ...
            relative_rect=pygame.Rect((((self.WIDTH -(self.WIDTH // 3.6))//2) + (self.WIDTH // 7.2) + 10, 160), (self.WIDTH // 7.2 - 10, 50)),
        ...
        while self.running:
            ...
            for event in pygame.event.get():
                ...
                if event.type==pygame.VIDEORESIZE:
                    ...
                    self.order_box.set_position(((self.WIDTH - (self.WIDTH // 3.6)) // 2, 160))

                    self.calculate_button.set_dimensions((self.WIDTH // 7.2 - 10, 50))

                    self.calculate_button.set_position((((self.WIDTH - (self.WIDTH // 3.6)) // 2) + (self.WIDTH // 7.2) + 10, 160))
