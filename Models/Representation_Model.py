...
class Graph_Representation:
    ...
    def __init__(self, surface, WIDTH, HEIGHT, CLOCK):
        ...
        for i in range(5):
            ...
            box = pygame_gui.elements.UITextEntryLine(
                relative_rect=pg.Rect((self.WIDTH*3//4 + 10, y_pos), (self.WIDTH//4 - 10, 30)),
                manager=self.manager,
        ...
        x_space = np.linspace(self.graph.l_bound, self.graph.r_bound, self.WIDTH*3//4)
    ...
    def recalculate_matrix(self):
        ...
        x_space = np.linspace(self.graph.l_bound - view_span*2, 
        ...
        while self.running:
            ...
            for event in pg.event.get():
                ...
                if event.type == pg.QUIT:
                    ...
                    self.graph.WIDTH, self.graph.HEIGHT = self.WIDTH*3//4, self.HEIGHT
                    ...
                    if self.surf_rect.collidepoint(self.m_x, self.m_y):
                        self.graph.movement(event=['zooming', (self.m_x, self.m_y), event.y])
                        self.recalculate_matrix()
